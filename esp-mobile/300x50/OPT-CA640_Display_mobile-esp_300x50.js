...
lib.ssMetadata = [
		{name:"OPT_CA640_Display_mobile_esp_300x50_atlas_1", frames: [[0,0,228,74],[0,76,188,37]]}
];
...
(lib.CachedBmp_234 = function() {
	this.initialize(ss["OPT_CA640_Display_mobile_esp_300x50_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-44.15,-9.8,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// box
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#002677").s().p("AlYB9Qg0AAgkglQglgkAAg0QAAgzAlgkQAkglA0AAIKxAAQA0AAAkAlQAlAkAAAzQAAA0glAkQgkAlg0AAg");
...
}).prototype = getMCSymbolPrototype(lib.CTAmobile, new cjs.Rectangle(-44.1,-12.5,94.1,25), null);
...
// stage content:
(lib.OPTCA640_Display_mobileesp_300x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	props.startPosition = startPosition;
	props.labels = {"repeat point":23};
	props.loop = loop;
	props.reversed = reversed;
	cjs.MovieClip.apply(this,[props]);

	this.actionFrames = [141,142];
	// timeline functions:
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).wait(141).call(this.frame_141).wait(1).call(this.frame_142).wait(1));
	...
	this.instance_1.setTransform(159.05,34.55,0.8,0.8,0,0,0,0.1,10.2);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({_off:false},0).to({alpha:1},8).wait(103).to({regY:10.1,scaleX:0.9,scaleY:0.9,x:159,y:34.5},3).to({regY:10.2,scaleX:0.8,scaleY:0.8,x:159.05,y:34.55},6).wait(8));

	// HEAD3
	this.instance_2 = new lib.HEAD3();
	this.instance_2.setTransform(8,43,1,1,0,0,0,0,38);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/OPT_CA640_Display_mobile_esp_300x50_atlas_1.png", id:"OPT_CA640_Display_mobile_esp_300x50_atlas_1"}
	],
	preloads: []
};
