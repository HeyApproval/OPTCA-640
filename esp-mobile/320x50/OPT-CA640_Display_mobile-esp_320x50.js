...
lib.ssMetadata = [
		{name:"OPT_CA640_Display_mobile_esp_320x50_atlas_1", frames: [[0,0,228,74],[0,76,188,37]]}
];
...
(lib.CachedBmp_232 = function() {
	this.initialize(ss["OPT_CA640_Display_mobile_esp_320x50_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.OPTCA640_Display_mobileesp_320x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(266,26.95,1.2,1.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(143));

	// CTA
	this.instance_1 = new lib.CTAmobile();
	this.instance_1.setTransform(169.05,34.55,0.8,0.8,0,0,0,0.1,10.2);
	this.instance_1.alpha = 0;
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(15).to({_off:false},0).to({alpha:1},8).wait(103).to({regY:10.1,scaleX:0.9,scaleY:0.9,x:169,y:34.5},3).to({regY:10.2,scaleX:0.8,scaleY:0.8,x:169.05,y:34.55},6).wait(8));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/OPT_CA640_Display_mobile_esp_320x50_atlas_1.png", id:"OPT_CA640_Display_mobile_esp_320x50_atlas_1"}
	],
	preloads: []
};
