...
lib.ssMetadata = [
		{name:"OPT_CA640_Display_mobile_300x50_atlas_1", frames: [[0,0,578,85],[580,0,188,46]]}
];
...
(lib.CachedBmp_230 = function() {
	this.initialize(ss["OPT_CA640_Display_mobile_300x50_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-44.15,-13.1,0.5,0.5);
...
}).prototype = getMCSymbolPrototype(lib.CTAmobile, new cjs.Rectangle(-44.1,-13.1,94.1,25.6), null);
...
// stage content:
(lib.OPTCA640_Display_mobile_300x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_2.setTransform(8,41,1,1,0,0,0,0,38);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/OPT_CA640_Display_mobile_300x50_atlas_1.png", id:"OPT_CA640_Display_mobile_300x50_atlas_1"}
	],
	preloads: []
};
