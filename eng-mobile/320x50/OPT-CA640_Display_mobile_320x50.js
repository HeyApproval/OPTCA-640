...
lib.ssMetadata = [
		{name:"OPT_CA640_Display_mobile_320x50_atlas_1", frames: [[0,0,578,85],[580,0,188,46]]}
];
...
(lib.CachedBmp_230 = function() {
	this.initialize(ss["OPT_CA640_Display_mobile_320x50_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.OPTCA640_Display_mobile_320x50 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/OPT_CA640_Display_mobile_320x50_atlas_1.png", id:"OPT_CA640_Display_mobile_320x50_atlas_1"}
	],
	preloads: []
};
